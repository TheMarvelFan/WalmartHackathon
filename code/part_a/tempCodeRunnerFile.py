...
try:
    ...
    df = pd.read_csv('D:\git projects\WalmartHackathon\input_datasets\part_a\part_a_input_dataset_5.csv')
    ...
    output_df.to_csv('D:\git projects\WalmartHackathon\output_datasets\part_a\part_a_output_dataset_5.csv', index=False)
