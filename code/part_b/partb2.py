...
input_file = "input_datasets\part_b\part_b_input_dataset_2.csv"
...
output_data.to_csv('C:\Users\harsh\walmart-sct-hackathon-round-1\output_datasets\part_b\part_b_output_dataset_2.csv', index=False)
